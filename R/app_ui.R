                                    ...
                                    shinydashboard::tabItems(
                                      ...
                                      shinydashboard::tabItem(tabName = "user_data",
                                                              ...
                                                              fluidRow(column(4, div(id = "box-button-right1", actionButton("return_to_start_button1", shiny::HTML("return to <br/> previous page"), class = "return-button"))),
                                                                       ...
                                                                       column(4, div(id = "box-button-left1", add_helper(shinyjs::disabled(actionButton("to_visualize_data_button1", shiny::HTML("data <br/> visualization"), class = "view-and-vis-button")), "Visualization"))))),
                                      shinydashboard::tabItem(tabName = "example_data",
                                                              ...
                                                              fluidRow(column(4, div(id = "box-button-right2", actionButton("return_to_start_button2", shiny::HTML("return to <br/> previous page"), class = "return-button"))),
                                                                       column(4, align = "center", div(id = "box-button-center2", add_helper(actionButton("to_view_data_button2", shiny::HTML("data <br/> preview"), class = "view-and-vis-button"), "View_data"))),
                                                                       column(4, div(id = "box-button-left2", add_helper(actionButton("to_visualize_data_button2", shiny::HTML("data <br/> visualization"), class = "view-and-vis-button"), "Visualization"))))),
